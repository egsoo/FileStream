...
def truncate_name(name: str, max_len: int = 30) -> str:
    ...
    if '.' in name:
        ...
        base, ext = name, ''
    return base[:max_len] + '...' + ext


def file_icon(mime_type: str) -> str:
...
async def gen_link(_id):
    ...
    share_link = f"https://t.me/share/url?url={stream_link}"
        ...
        reply_markup = InlineKeyboardMarkup(
            [
                ...
                [
                    ...
                    InlineKeyboardButton("ᴅᴇʟᴇᴛᴇ 👻", callback_data=f"msgdelpvt_{_id}"),
